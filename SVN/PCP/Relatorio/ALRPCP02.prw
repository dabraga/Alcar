...
oReport := TReport():New("ALRPCP02", cTitulo, cPerg, {|oReport| ReportPrint(oReport)}, cAjuda)
...
cQuery += "	SB1B.B1_DESC AS DESCMP, D4_QTDEORI, C2_ZZIMP "
...
PutSX1(cPerg, "07", "Quantidade:",	"Quantidade:",	"Quantidade:",	"MV_PAR07", "N", 03, 0, 0, "G",,,,, 		"MV_PAR07",,,,,,,,,,,,,,,,, {"Informe a quantidade da mistura"}, 	{"Informe a quantidade da mistura"}, 	{"Informe a quantidade da mistura"})*/
	...
	aAdd(aParBox, {1, "Kg:", Space(19), "@E999999.999999999999",,,,18, .T. })
	aAdd(aParBox, {1, "Quantidade:", Space(3), "@E999",,,,3, .T. })
